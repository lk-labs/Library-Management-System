...
<tr><td class="labels">User : </td><td><select name="name" class="fields" required >
...
{
    ?>
    <option value="<?php echo $y['sid'];?>"><?php echo $y['name'];?></option>
    <?php
}
?>
</select></td></tr>
<tr><td colspan="2" align="center"><input type="submit" value="DELETE" class="fields" /></td></tr>
</table>
</form>
<br />
<br />
